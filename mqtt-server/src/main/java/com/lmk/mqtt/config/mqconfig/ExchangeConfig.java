...
public class ExchangeConfig {
    ...
    public FanoutExchange fanoutExchange(){
        ExchangeEnum exchangeEnum = ExchangeEnum.DEFAULT_FANOUT_EXCHANGE;
        return new FanoutExchange(exchangeEnum.getExchangeName(),exchangeEnum.isDurable(),false,null);
    }
